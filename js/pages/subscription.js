                ...
                <main class="main-content">
                    ...
                    <div style="max-width: 800px; margin: 0 auto;">
                        <div class="glass-card" style="text-align: center; margin-bottom: 3rem;">
                            ...
                            <p style="color: var(--text-secondary);">Join our elite community and get instant access to all leaks, analyzes and resources.</p>
                        </div>
    ...
    attachEvents() {
        ...
        form.addEventListener('submit', (e) => {
            ...
            setTimeout(() => {
                ...
                Components.Toast('Success! Your account has been upgraded to Premium.');
