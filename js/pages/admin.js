Pages.Admin = {
                    ...
                    <div class="glass-card modal-content" style="max-width: 600px;">
                        ...
                        <form id="post-form" style="margin-top: 1.5rem;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" id="p-link" class="input-field" placeholder="https://..." required>
                            </div>
                            <div class="form-group">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; gap: 0.5rem;">
                                        <select class="input-field" style="padding: 0.25rem; font-size: 0.75rem; width: 100px;" onchange="State.updateUserRole(${user.id}, this.value); Components.Toast('User role updated to ' + this.value); App.render();">
    ...
    attachEvents() {
        ...
        form.addEventListener('submit', (e) => {
            ...
            Components.Toast('Post published successfully!');
            this.hidePostModal();
            App.render();
        });
    }
